...
public class Objective4Lab2{
  public static void main(String [] args){
    ...
    int num1 = 0, num2 = 0, num3 = 0, num_sum = 0;
    double dub1 = 0.0, dub2 = 0.0, dub3 = 0.0, dub_sum = 0;
    ...
    dub_sum = (dub1+dub2+dub3);



    System.out.println("The sum of " + num1 +" + "+ num2 +" + " + num3 + " = " + num_sum);
    System.out.println("The sum of " + dub1 +" + "+ dub2 +" + " + dub3 + " = " + dub_sum);
